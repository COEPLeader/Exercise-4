...
1. Assigns variable and reads in spreadsheet
2. Removes the period from in front of the state names (that was there for some reason).
3. Selects new state column and population data
4. Makes the states lowercase

1. Creates new variable
2. Calls in old starbucks data
3. Appends the population of each state to the old data
4. Creates a column of starbucks for every 10000 people
...
fav_places <- tibble(
  ...
  long = c(-93.1632130682622, -93.1712321, -93.16503218194325, -93.12526680731808, -93.12127079579042, -93.13631499984636, -93.14826673723597, 
          -93.1725207001496, -93.16308646788002, -93.16736408635319, 
